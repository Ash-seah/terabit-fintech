...
MARKETMAP_STOCKS: tuple[MarketMapStock, ...] = (
    ...
    MarketMapStock("ACN", "Accenture", "IT consulting and managed services.", "Technology", 2.1e11, "accenture.com"),
    ...
    MarketMapStock("SHOP", "Shopify", "E-commerce software platform.", "Technology", 1.2e11, "shopify.com"),
